...
hl.on("hyprland.start", function ()
  ...
  hl.exec_cmd("sh $HOME/.config/hypr/battery_notify.sh")
end)
...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {teal}, angle = 90 },
...
hl.bind(mainMod .. " + SHIFT + Q", hl.dsp.exec_cmd("librewolf"))
...
hl.bind(mainMod .. " + SHIFT + N", hl.dsp.exec_cmd("swaync-client -t -sw"))    -- dwindle only
hl.bind(mainMod .. " + L", hl.dsp.exec_cmd("hyprlock"))    -- dwindle only
...
hl.bind(mainMod .. " + XF86AudioRaiseVolume", hl.dsp.exec_cmd("wpctl set-volume -l 1 @DEFAULT_AUDIO_SINK@ 1%+"), { locked = true, repeating = true })
...
hl.bind("XF86Calculator", hl.dsp.exec_cmd("playerctl play-pause -p spotify"), { locked = true })
